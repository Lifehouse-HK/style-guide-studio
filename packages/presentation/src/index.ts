...
*{box-sizing:border-box}body{margin:0;color:#1d2529;background:white;font-family:serif;font-size:11pt;line-height:1.65}main{max-width:${layout === 'parallel' ? '1200' : '800'}px;margin:auto;padding:2rem}
