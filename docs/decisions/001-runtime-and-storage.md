...
- WeasyPrint with a Python adapter is the selected qualification path. PDF finishing must preserve the document catalogue, accessibility tree and named destinations; no renderer is considered fully qualified until measured outputs pass the plan.
